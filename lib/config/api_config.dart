...
class CustomerApiConfig {
  ...
  static String orderHistory(String sessionId) => '$baseUrl/public/orders/history/$sessionId';
  static String orderReceipt(String orderId) => '$baseUrl/public/orders/receipt/$orderId';
